...
export default function Layout({ className = '', preview = false, children }) {
  return (
    <>
      <Head>
        ...
        <meta
          ...
          content="Sean Scanlan is an artist and developer specializing in physical and digital creative coding"
        />
      ...
      {preview && (
        <div className="Preview-warning">
          <p>
            You are looking at the website in preview mode, which displays
            unpublished changes from Contentful.
          </p>
        </div>
      )}
    </>
